...
<label
	...
	class={clsx(
		...
		value === 'm' &&
			'male bg-[#e9f2ef] text-[#98b2b8] has-checked:bg-[#98b2b8] has-checked:text-[#e9f2ef]',
		value !== 'm' &&
			'female bg-[#fae5e2] text-[#d69d95] has-checked:bg-[#d69d95] has-checked:text-[#fae5e2]'
	)}
>
